      ...
      return (
        ...
        <IonItemSliding>
                    ...
                    <IonItemOptions side="end" className="h-83">
                      <IonItemOption  onClick={() => { console.log("OK"); this.props.history.push('/page62/Page62'); } } >Edit</IonItemOption>
          ...
          <IonPage className="z-999">
            ...
            <IonContent>
              ...
              <IonRow className="px-7">
                    <IonCol size="10">
                      <p className="small-title asd">Trade Details for fixed income</p>
                    </IonCol>
                    <IonCol size="2">
                    <IonThumbnail>
              ...
              <IonList>
                ...
                <IonButton className="cus-color mt-4" expand="full" onClick={() => { console.log("OK"); this.props.history.push('/page61/Page61'); } } >Submit</IonButton>      
              </IonContent>
