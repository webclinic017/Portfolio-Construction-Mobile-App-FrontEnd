...
//const { name } = useParams<{ name: string; }>();
  ...
  <IonPage className="z-999">
    ...
    <IonContent>
      ...
      <h4 className="ml-3  mb-10 mt-10">Why not us</h4>

      <IonItem className="cus-input1 mb-12 mt-5">
        <IonRow className="w-100">
          <IonCol className="d-flex f-14 bb" size="12">
            <h6>No Chronicales of multi stories</h6>
          </IonCol>
          <IonCol className="d-flex f-14" size="12">
            <p>You won't find us risking capital in pursuit of 10x-12x return stories</p>
          </IonCol>
        </IonRow>
      </IonItem>
      <IonItem className="cus-input1 mb-12 mt-5">
